...
export const GEMINI_LIVE_SYSTEM_INSTRUCTION = [
  ...
  "MediaPipe follow metadata contains object labels, visibility, position, track id, active target, and follow state only.",
  "</vision_rules>",
  "<scenario_rules>",
  ...
  "While follow is active, do not call any other scenario. Answer questions normally from activeTarget metadata, or call stop_following only for explicit stop-following intent.",
  ...
  "Do not call tools every frame. The local MediaPipe controller handles continuous look_left/look_right corrections after follow_target succeeds.",
  "</follow_rules>",
  "<safety_rules>",
