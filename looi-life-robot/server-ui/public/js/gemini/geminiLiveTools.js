...
const GEMINI_LIVE_SYSTEM_INSTRUCTION = [
  ...
  "you respond with one very short natural personality comment when body_context arrives or stay silent, also stay silent if it would interrupt the user or feel repetitive.",
