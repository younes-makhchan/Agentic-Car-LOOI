...
export const GEMINI_LIVE_SYSTEM_INSTRUCTION = [
  ...
  "During focused follow mode, live Gemini video is paused and Roboflow WebRTC metadata inside <vision_context> tags becomes the visual source for activeTarget and follow questions.",
  ...
  "Roboflow WebRTC follow metadata contains object labels, visibility, position, track id, active target, and follow state only.",
  "</vision_rules>",
  "<scenario_rules>",
